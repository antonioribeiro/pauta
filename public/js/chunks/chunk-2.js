                    ...
                    return (function(t) {
                        ...
                        function(t, e, n) {
                            ...
                            t.exports = function(t, e, n, g, m, x, w) {
                                ...
                                var S,
                                    ...
                                    C = M[p] || M[h] || (m && M[m]),
                                    T = (!d && C) || A(m),
                                    L = m ? (k ? A('entries') : T) : void 0,
                                    V = 'Array' == e ? M.entries || C : C
                                if (
                                    (V &&
                                        ((_ = f(V.call(new t()))),
                                        _ !== Object.prototype &&
                        ...
                        function(t, e, n) {
                            ...
                            var o = n(49),
                                ...
                                m = r(g)
                            e.default = {
                                mixins: [b.default, y.default, m.default],
                                props: {
                                    value: { default: null },
                                    options: {
                                        type: Array,
                                ...
                                created: function() {
                                    ;(this.mutableValue = this.value),
                                        (this.mutableOptions = this.options.slice(
                                            0,
                                        )),
                                ...
                                methods: {
                                    ...
                                    deselect: function(t) {
                                        ...
                                        if (this.multiple) {
                                            var n = -1
                                            this.mutableValue.forEach(function(
                                                r,
                                            ) {
                                                ;(r === t ||
                                                    (e.index &&
                                    ...
                                    isOptionSelected: function(t) {
                                        var e = this
                                        return this.valueAsArray.some(function(
                                            n,
                                        ) {
                                            return 'object' ===
                                                ('undefined' == typeof n
